<?php
    ...
    if( isset($_GET['p2']) && $_GET['p2'] == 'desconectar' ){
        ...
        <form class="validar_form_login" method='post' action='<?php echo \core\URL::generar("usuarios/form_login_validar"); ?>' >
            ...
            <?php echo iText('Usuario', 'dicc'); ?>:<br/><input type='text' id='login' name='login' value='' size="15"/><br/>
            <?php echo iText('Contraseña', 'dicc'); ?>:<br/><input type='password' id='password' name='password' value='' size="15"/><br/>
            <center>
